# `COSTA_jll.jl` (v2.2.2+0)

[![deps](https://juliahub.com/docs/COSTA_jll/deps.svg)](https://juliahub.com/ui/Packages/COSTA_jll/aDKbA?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0019882d79dae0561063c537ae3140ebf71cea6e/C/COSTA/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `COSTA_jll.jl` have been built from these sources:

* git repository: https://github.com/eth-cscs/COSTA/ (revision: `bb84528d023db9a6b00ad729fb44b8c3cef8c981`)

## Platforms

`COSTA_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `COSTA_jll.jl`:
